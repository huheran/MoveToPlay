...
- MAX30102 平时保持低功耗关闭；玩家点击“结束运动并测量心率”后，Companion 经 USB CDC 与 ESP-NOW 唤醒 Blade，检测手指后静止测量 10 秒，完成后自动关闭并生成本地运动报告。
